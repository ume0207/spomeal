      ...
      html: `
        <div style="font-family:'Hiragino Kaku Gothic ProN','Noto Sans JP',sans-serif; max-width:480px; margin:0 auto; padding:32px 24px; background:#ffffff;">
          ...
          <div style="text-align:center; margin-bottom:16px;">
            <a href="${resetLink}"
               style="display:inline-block; background:#22c55e; color:white; font-weight:700; font-size:15px; padding:14px 32px; border-radius:10px; text-decoration:none;">
              パスワードを再設定する
            </a>
          </div>
          <p style="color:#6b7280; font-size:12px; text-align:center; margin-bottom:20px;">
            ボタンが押せない場合は、以下のURLをブラウザにコピー＆ペーストしてください：<br>
