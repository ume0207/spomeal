        ...
        <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <Section title="第4条（利用料金および支払方法）">
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>プランの詳細および料金は「
                <Link href="/plans" className="text-green-600 underline">料金プランページ</Link>
                」および「
                <Link href="/tokushoho" className="text-green-600 underline">特定商取引法に基づく表記</Link>
                」をご確認ください。
              </li>
            </ol>
          </Section>
          ...
          <Section title="第5条（禁止事項）">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>以下の表現を含み、または含むと当社が判断する内容を本サービス上に投稿したり送信したりする行為
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                  <li>過度に暴力的な表現</li>
                  <li>露骨な性的表現</li>
          ...
          <Section title="第13条（個人情報の取扱い）">
            <p>
              ...
              <Link href="/privacy" className="text-green-600 underline">プライバシーポリシー</Link>
              」に従い適切に取り扱うものとします。
            </p>
          </Section>
          ...
          <div className="pt-8 border-t text-right">
            <p className="text-gray-600">株式会社トレイズ</p>
            <p className="text-gray-500 text-xs mt-1">〒650-0011 兵庫県神戸市中央区下山手通2-4-10 5階</p>
          </div>
        </div>
